...
import 'package:foodifi/pages/payment/CustomShapeBorder.dart';
...
//            mainAxisAlignment: MainAxisAlignment.start,
            children: <Widget>[
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text("Meal Type", style: TextStyle(fontSize: 12,)),
                            ],
                          )
                      ),
                      Container(
                        ...
                        flex: 1,
                          child:  RadioListTile(
                              dense: false,
                              groupValue: mealType,
                              title: Text("${Strings.VEG}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                              value: '${Strings.VEG}',
                              onChanged: (val) {
                                setState(() {
                                  mealType = val;
                        ...
                        Expanded(
                          ...
                          child:  RadioListTile(
                              dense: false,
                              groupValue: mealType,
                              title: Text("${Strings.NONVEG}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Expanded(
                              ...
                              child: RadioListTile(
                                groupValue: mealTime,
                                title: Text("${Strings.BREAKFAST}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                            ...
                            Expanded(
                              ...
                              child:  RadioListTile(
                                groupValue: mealTime,
                                title: Text("${Strings.LUNCH}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                                value: '${Strings.LUNCH}',
                                onChanged: (val) {
                                  setState(() {
                                    mealTime = val;
                            ...
                            Expanded(
                              ...
                              child:  RadioListTile(
                                groupValue: mealTime,
                                title: Text("${Strings.DINNER}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ...
              Expanded(
                flex: 1,
                child: Container(
                    margin: const EdgeInsets.only(top:25.0, left: 20, right: 20),
                    alignment: Alignment.topLeft,
                    decoration:  BoxDecoration(
                        borderRadius: BorderRadius.circular(20.0),
                        color: Colors.grey[200]
                      ...
                      child:  Column(
                        ...
                        children: <Widget>[
                          Padding(
                              ...
                              child: Text("Subscription Type:", style: TextStyle(fontSize: 15),)
                          ),Column( children:_list.map((data) =>
                              RadioListTile(
                                title: Text("${data.subscriptionType}"),
                                subtitle: Text("${data.subscriptionPrice}"),
                                groupValue: id,
                                value: data.subscriptionId,
                                onChanged: (val) {
                                  setState(() {
                                    radioItemHolder = data.subscriptionType;
