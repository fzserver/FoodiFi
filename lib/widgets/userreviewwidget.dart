...
import 'package:foodifi/widgets/photosreviewwidget.dart';
import 'package:foodifi/widgets/ratingbar.dart';

class UserReviewWidget extends StatelessWidget{

  String reviewdata = "I have been working at Swiggy full-time for more than a year. Im Glad to work in this organisation more than a office its like a Family to me, it gives us that environment to be safe and secure. No downsides of SWIGGY according to me";
          ...
          children: <Widget>[
            Container(
              ...
              child: Row(
                children: <Widget>[
                  CircleAvatar(
                    backgroundImage: NetworkImage('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80'),
                  ),
                  SizedBox(width: 5,),
                  Expanded(
                    child: Column(
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child:  Text("follow", style: TextStyle(color:  Colors.lightBlueAccent, fontSize: 15),),
                      )
                  )
                ],
              ),
