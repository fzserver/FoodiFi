                ...
                child: Stack(
                  children: <Widget>[
                    Padding(padding: EdgeInsets.only(top: 0),
                      child: ClipPath(clipper: CurvedClipper(),
                                  ...
                                  Expanded(
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                            child: paymentWidget(_list[index], _isVisible),
                                            onTap: () {
                                      ...
                                      child: MaterialButton(
                                        ...
                                        child: new Text('Payment',
                                            style: new TextStyle(
                                                ...
                                                color: Colors.white)),
                                        onPressed: () {
                                          bottomSheetModel.mainBottomSheet(
                                              context);
                                        },
                                      ),
                                    ),
              ...
              child: Padding(
                ...
                child: Row(
                  children: <Widget>[
                   ...
                   Expanded(
                     child:  Text(
                       "${cardNumber}", style: TextStyle(color: Colors.black, fontSize: 18),
                     ),
                   ),
//                Offstage(
//                  offstage: false,
